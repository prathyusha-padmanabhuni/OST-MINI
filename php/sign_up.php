...
<head>
  ...
  <div class="container">
   <div class="forms-container">
	...
	<form method="post" action="sign_up.php" class="sign-in-form" name="myform2" >
	 	<h2 class="title">Sign in</h2>
			...
			<p id="id9" class="jsvalid"></p>
				<input class="btn solid" type="submit" name="login" value="Login" onclick ="return fun2()"  />
				<div>
				<i class="fas fa-lock"></i>
				<input class="btn solid" type="submit" name="forget" value="forget password"  />
				<p id="id10" class="jsvalid"></p>
			</div>
	 ...
	 <!-- <form method="post" action="sign_up.php" class="sign-in-form" style="margin-top:350px">
	 ...
	 <?php 
            ...
            if(isset($_POST['login'])) 
            {
                ...
                else
                {
                  ...
                  {
					echo "<script> 
					 document.getElementById('id9').innerHTML = 'incorrecr password'
					 </script>";
				...
				if(isset($_POST['forget'])) 
				{
					...
					{
						echo "<script> 
					 document.getElementById('id10').innerHTML = 'please enter username'
					 </script>";
					}
					else
					{
						...
						{
							echo "<script> 
							document.getElementById('id10').innerHTML = 'invalid id'
							</script>";
						}
						else
						{
							...
							$sub="E-CANTEEN";
							$msg="Hiii.. :
									This is otp to reset to your password   :$otp
											THANK YOU";
							mail($mail1,$sub,$msg);
...
?>	
     <form  name="myform" method="post" action="sign_up.php"  class="sign-up-form" onsubmit="return fun1()" >
  ...
  <script >
		...
		function fun2()
		{
			...
			if (q=="")
			{
				document.getElementById("id8").innerHTML="Fill the username";
				return false;
			}
