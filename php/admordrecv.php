...
<table class="center" style="width:75%;margin-top:-25% ">
    ...
    <?php
						...
						try{
							...
							{
								$sql="select * from orderp where status=1 order by orderid desc";
								$stmt=$pdo->query($sql);
                      ...
                      <?php
                       ...
                       ?>
											 ...
											 <td>
                          <form method="post" action="admordrecv.php">
												  <input type="hidden"   value="<?=$row['orderid']?>" name="orderid"/>
												 
												  <input type="submit"  class="accept" value="done" name="accept"/>&nbsp &nbsp
