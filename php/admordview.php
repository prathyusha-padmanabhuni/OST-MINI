...
<table class="center" style="width:75%;margin-top:-25% ">
    ...
    <?php
						...
						try{
							...
							{
								$sql="select * from orderp order by orderid desc";
								$stmt=$pdo->query($sql);
                      ...
                      <?php
                           if($row['status']==0)
                             echo '<td style="color:gray;font-weight:bold;font-size:20px">',"PROGRESS...",'</td>';
                              ...
                              echo '<td style="color:blue;font-weight:bold;font-size:20px">',"DONE",'</td>';
                            else if($row['status']==4)
                              echo '<td style="color:green;font-weight:bold;font-size:20px">',"DELIVERED",'</td>';
                            else if($row['status']==5)
                              echo '<td style="color:brown;font-weight:bold;font-size:20px">',"CANCELED",'</td>';
                      ?>
                    </tr>
							<?php }
							}
